...
<html>
    ...
    <body>
		...
		<div class="content-wrapper">
	        ...
	        <html:button property="screen2" onclick="document.location.href='screen1.jsp';">
	            <bean:message key="lbl.display.backtoscreen1" />
	        </html:button>
		...
		<div class="content-wrapper">
	        ...
	        <h3>Newly Persisted Entity</h3>
			
			<b>${sessionScope.accountDataForm.accountData}</b>
		</div>
