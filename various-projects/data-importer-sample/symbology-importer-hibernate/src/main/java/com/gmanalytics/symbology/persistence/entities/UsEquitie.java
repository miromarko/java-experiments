 ...
 */
@Entity
@Table(name = "US_EQUITIES")
@XmlRootElement
public class UsEquitie extends Symbol implements Serializable {
    ...
    public UsEquitie() {
        setAsset_type(AssetClass.US_EQUITIES);
    }

    public UsEquitie(int status, String underlying_gma_ticker, String company_name, double tick_size, String sedol, String gma_name, String currency, Date generated_time, String gma_ticker, String activ_name, AssetClass asset_type) {
    ...
    public boolean equals(Object obj) {
        ...
        final UsEquitie other = (UsEquitie) obj;
